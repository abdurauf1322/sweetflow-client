    ...
    <div className="space-y-6 h-full flex flex-col">
        ...
        <div className="space-y-6 overflow-y-auto pr-1 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="glass-panel rounded-2xl p-5 border border-brand-500/20 bg-gradient-to-br from-brand-950/20 to-slate-900/40 relative overflow-hidden group shadow-lg shadow-brand-500/5 transition-all">
              {isBoss && !isEditingBalance && (
                <button
                  ...
                  className="absolute top-3 right-3 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white p-1.5 rounded-lg border border-white/5 hover:border-white/10 transition cursor-pointer flex items-center justify-center z-10"
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <span className="text-xs text-gray-400 font-medium tracking-wider uppercase block">Asosiy Balans</span>
                  {isEditingBalance ? (
                    <form onSubmit={handleUpdateBalanceSubmit} className="flex items-center gap-2 mt-1.5 w-full">
                      <div className="relative flex-1 min-w-0">
                        <input
                          type="text"
                          className="bg-slate-950 border border-white/10 rounded-lg text-white w-full pl-2 pr-10 py-1.5 focus:outline-none focus:ring-1 focus:ring-brand-500 text-sm font-mono font-bold"
                          value={newBalance}
                          onChange={(e) => setNewBalance(formatNumberWithSpaces(e.target.value))}
                          autoFocus
                        />
                        <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] text-gray-500 font-bold">so'm</span>
                      </div>
            ...
            <div 
              ...
              className="glass-panel rounded-3xl p-6 border border-orange-500/20 bg-gradient-to-br from-orange-900/20 to-slate-900/60 flex flex-col justify-between relative overflow-hidden group shadow-lg hover:shadow-orange-500/10 transition-all cursor-pointer hover:bg-slate-800/40"
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Jami Xarajat (Tovarlar)</span>
            ...
            <div 
              ...
              className="glass-panel rounded-3xl p-6 border border-red-500/20 bg-gradient-to-br from-red-900/20 to-slate-900/60 flex flex-col justify-between relative overflow-hidden group shadow-lg hover:shadow-red-500/10 transition-all cursor-pointer hover:bg-slate-800/40"
            >
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Boshqa Xarajatlar</span>
            ...
            <div 
              ...
              className="glass-panel rounded-3xl p-6 border border-emerald-500/20 bg-gradient-to-br from-emerald-900/20 to-slate-900/60 flex flex-col justify-between relative overflow-hidden group shadow-lg hover:shadow-emerald-500/10 transition-all cursor-pointer hover:bg-slate-800/40"
            >
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Sof Foyda (Profit)</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div 
              ...
              className="glass-panel rounded-3xl p-6 border border-brand-500/10 bg-gradient-to-br from-brand-950/20 to-slate-900/40 flex items-center space-x-4 relative overflow-hidden group hover:border-brand-500/20 transition-all cursor-pointer hover:bg-slate-800/40"
            >
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div>
                <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Jami Savdo</span>
                <h3 className="text-xl font-black text-white mt-1 tracking-tight">{formatCurrency(report.totalSales)}</h3>
              </div>
            </div>
            ...
            <div 
              ...
              className="glass-panel rounded-3xl p-6 border border-emerald-500/10 bg-gradient-to-br from-emerald-950/20 to-slate-900/40 flex items-center space-x-4 relative overflow-hidden group hover:border-emerald-500/20 transition-all cursor-pointer hover:bg-slate-800/40"
            >
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div>
                <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Naqd Tushum</span>
            ...
            <div 
              ...
              className="glass-panel rounded-3xl p-6 border border-red-500/10 bg-gradient-to-br from-red-950/20 to-slate-900/40 flex items-center space-x-4 relative overflow-hidden group hover:border-red-500/20 transition-all cursor-pointer hover:bg-slate-800/40"
            >
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div>
                <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Nasiya (Qarz)</span>
            ...
            <div 
              ...
              className="glass-panel rounded-3xl p-6 border border-yellow-500/10 bg-gradient-to-br from-yellow-950/20 to-slate-900/40 flex items-center space-x-4 relative overflow-hidden group hover:border-yellow-500/20 transition-all cursor-pointer hover:bg-slate-800/40"
            >
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div>
                <span className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Sotilgan Mahsulot</span>
          ...
          <div className="glass-panel rounded-3xl p-6 border border-white/5 space-y-4 bg-slate-900/30">
            ...
            <div className="w-full bg-slate-950/80 rounded-full h-5 sm:h-6 flex overflow-hidden border border-white/10 shadow-inner">
      ...
      {isExpensesHistoryModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="glass-panel border-white/10 max-w-2xl w-full rounded-3xl p-6 relative my-auto shadow-2xl shadow-red-900/20 border-t-red-500/20">
            <button
              onClick={() => setIsExpensesHistoryModalOpen(false)}
              className="absolute top-4 right-4 text-gray-400 hover:text-white transition bg-white/5 p-2 rounded-xl hover:bg-white/10 cursor-pointer"
            >
              <X size={20} />
            </button>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Boshqa xarajatlar tarixi</h3>
                <p className="text-xs text-gray-400 mt-0.5">{getPeriodLabel()} ({report?.expensesList?.length || 0} ta yozuv)</p>
              </div>
            </div>
            
            <div className="bg-slate-950/50 rounded-2xl border border-white/5 overflow-hidden max-h-[60vh] overflow-y-auto">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                <thead>
                  <tr className="bg-slate-900/80 text-gray-400 uppercase tracking-wider font-semibold border-b border-white/5 sticky top-0 backdrop-blur-md">
                ...
                <tbody className="divide-y divide-white/5">
                  {!report?.expensesList || report.expensesList.length === 0 ? (
                    <tr>
                      <td colSpan="3" className="p-8 text-center text-gray-500">Bu davrda boshqa xarajatlar mavjud emas.</td>
                    </tr>
                  ) : (
                    report.expensesList.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)).map((expense, idx) => (
                      <tr key={expense.id || idx} className="hover:bg-white/[0.02] transition">
                        <td className="p-4 text-gray-300 font-mono flex items-center space-x-2 whitespace-nowrap">
                          <Clock size={14} className="text-gray-500" />
                          <span>{new Date(expense.createdAt).toLocaleString('ru-RU')}</span>
                        </td>
                        <td className="p-4 text-white font-medium break-words max-w-[200px]">
                          {expense.description}
                        </td>
      ...
      {isPurchaseHistoryModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="glass-panel border-white/10 max-w-4xl w-full rounded-3xl p-6 relative my-auto shadow-2xl shadow-orange-900/20 border-t-orange-500/20">
            <button onClick={() => setIsPurchaseHistoryModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white transition bg-white/5 p-2 rounded-xl hover:bg-white/10 cursor-pointer">
              <X size={20} />
            </button>
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-orange-500/20 p-2.5 rounded-xl text-orange-400"><DollarSign size={24} className="rotate-180" /></div>
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Omborga qilingan tovar xaridlari</h3>
                <p className="text-xs text-gray-400 mt-0.5">{getPeriodLabel()} ({purchases?.length || 0} ta yozuv)</p>
              </div>
            </div>
            <div className="bg-slate-950/50 rounded-2xl border border-white/5 overflow-hidden max-h-[60vh] overflow-y-auto">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                ...
                <tbody className="divide-y divide-white/5">
                  {loadingPurchases ? (
                    ...
                    <tr><td colSpan="5" className="p-8 text-center text-gray-500">Bu davrda tovar xaridlari mavjud emas.</td></tr>
                  ) : (
                    purchases.map((hist, idx) => (
                      <tr key={hist.id || idx} className="hover:bg-white/[0.02] transition">
                        <td className="p-4 text-gray-300 font-mono whitespace-nowrap"><Clock size={14} className="inline mr-2 text-gray-500" />{new Date(hist.createdAt).toLocaleString('ru-RU')}</td>
                        <td className="p-4 text-white font-medium">{hist.product?.name || 'Noma\'lum'}</td>
      ...
      {isProfitDetailsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="glass-panel border-white/10 max-w-4xl w-full rounded-3xl p-6 relative my-auto shadow-2xl shadow-emerald-900/20 border-t-emerald-500/20">
            <button onClick={() => setIsProfitDetailsModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white transition bg-white/5 p-2 rounded-xl hover:bg-white/10 cursor-pointer"><X size={20} /></button>
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-emerald-500/20 p-2.5 rounded-xl text-emerald-400"><TrendingUp size={24} /></div>
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Mahsulotlar kesimida sof foyda</h3>
                <p className="text-xs text-gray-400 mt-0.5">{getPeriodLabel()}</p>
              </div>
            </div>
            <div className="bg-slate-950/50 rounded-2xl border border-white/5 overflow-hidden max-h-[60vh] overflow-y-auto">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                ...
                <tbody className="divide-y divide-white/5">
                  {!report?.productProfitList || report.productProfitList.length === 0 ? (
                    <tr><td colSpan="5" className="p-8 text-center text-gray-500">Hech qanday savdo mavjud emas.</td></tr>
                  ) : (
      ...
      {isSalesHistoryModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="glass-panel border-white/10 max-w-4xl w-full rounded-3xl p-6 relative my-auto shadow-2xl shadow-brand-900/20 border-t-brand-500/20">
            <button onClick={() => setIsSalesHistoryModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white transition bg-white/5 p-2 rounded-xl hover:bg-white/10 cursor-pointer"><X size={20} /></button>
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-brand-500/20 p-2.5 rounded-xl text-brand-400"><TrendingUp size={24} /></div>
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Barcha Savdolar Tarixi</h3>
                <p className="text-xs text-gray-400 mt-0.5">{getPeriodLabel()} ({report?.salesHistory?.length || 0} ta savdo)</p>
              </div>
            </div>
            <div className="bg-slate-950/50 rounded-2xl border border-white/5 overflow-hidden max-h-[60vh] overflow-y-auto">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                ...
                <tbody className="divide-y divide-white/5">
                  {!report?.salesHistory || report.salesHistory.length === 0 ? (
                    <tr><td colSpan="5" className="p-8 text-center text-gray-500">Bu davrda savdolar mavjud emas.</td></tr>
                  ) : (
                    report.salesHistory.map((order, idx) => (
                      <tr key={order.id} className="hover:bg-white/[0.02] transition">
                        <td className="p-4 text-gray-300 font-mono whitespace-nowrap"><Clock size={14} className="inline mr-2 text-gray-500" />{new Date(order.createdAt).toLocaleString('ru-RU')}</td>
                        <td className="p-4 text-white font-medium">{order.store?.name || 'Noma\'lum'}</td>
                        <td className="p-4 text-right text-white font-bold">{formatCurrency(order.totalAmount)}</td>
      ...
      {isCashInflowModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="glass-panel border-white/10 max-w-4xl w-full rounded-3xl p-6 relative my-auto shadow-2xl shadow-emerald-900/20 border-t-emerald-500/20">
            <button onClick={() => setIsCashInflowModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white transition bg-white/5 p-2 rounded-xl hover:bg-white/10 cursor-pointer"><X size={20} /></button>
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-emerald-500/20 p-2.5 rounded-xl text-emerald-400"><DollarSign size={24} /></div>
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Naqd Tushum Tarixi</h3>
                <p className="text-xs text-gray-400 mt-0.5">{getPeriodLabel()} (Savdolardan olingan naqd to'lovlar)</p>
              </div>
            </div>
            <div className="bg-slate-950/50 rounded-2xl border border-white/5 overflow-hidden max-h-[60vh] overflow-y-auto">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                ...
                <tbody className="divide-y divide-white/5">
                  {!report?.salesHistory || report.salesHistory.filter(o => Number(o.totalAmount) - Number(o.debtAmount) > 0).length === 0 ? (
                    <tr><td colSpan="4" className="p-8 text-center text-gray-500">Bu davrda naqd tushum mavjud emas.</td></tr>
                  ) : (
                    report.salesHistory.filter(o => Number(o.totalAmount) - Number(o.debtAmount) > 0).map((order) => (
                      <tr key={order.id} className="hover:bg-white/[0.02] transition">
                        <td className="p-4 text-gray-300 font-mono whitespace-nowrap"><Clock size={14} className="inline mr-2 text-gray-500" />{new Date(order.createdAt).toLocaleString('ru-RU')}</td>
                        <td className="p-4 text-white font-medium">{order.store?.name || 'Noma\'lum'}</td>
                        <td className="p-4 text-right text-gray-400 font-mono">{formatCurrency(order.totalAmount)}</td>
      ...
      {isDebtStoresModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="glass-panel border-white/10 max-w-4xl w-full rounded-3xl p-6 relative my-auto shadow-2xl shadow-red-900/20 border-t-red-500/20">
            <button onClick={() => setIsDebtStoresModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white transition bg-white/5 p-2 rounded-xl hover:bg-white/10 cursor-pointer"><X size={20} /></button>
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-red-500/20 p-2.5 rounded-xl text-red-400"><AlertTriangle size={24} /></div>
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Qarzdor Do'konlar ro'yxati</h3>
                <p className="text-xs text-gray-400 mt-0.5">Joriy vaqtda haqiqatda qarzi bor do'konlar ({report?.debtStores?.length || 0} ta)</p>
              </div>
            </div>
            <div className="bg-slate-950/50 rounded-2xl border border-white/5 overflow-hidden max-h-[60vh] overflow-y-auto">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                  ...
                  {!report?.debtStores || report.debtStores.length === 0 ? (
                    ...
                    report.debtStores.map((store) => (
                      <tr key={store.id} className="hover:bg-white/[0.02] transition">
                        <td className="p-4 text-white font-medium">{store.name} {store.ownerName ? `(${store.ownerName})` : ''}</td>
      ...
      {isSoldProductsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="glass-panel border-white/10 max-w-4xl w-full rounded-3xl p-6 relative my-auto shadow-2xl shadow-yellow-900/20 border-t-yellow-500/20">
            <button onClick={() => setIsSoldProductsModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white transition bg-white/5 p-2 rounded-xl hover:bg-white/10 cursor-pointer"><X size={20} /></button>
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-yellow-500/20 p-2.5 rounded-xl text-yellow-400"><Box size={24} /></div>
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Sotilgan Mahsulotlar Statistikasi</h3>
                <p className="text-xs text-gray-400 mt-0.5">{getPeriodLabel()}</p>
              </div>
            </div>
            <div className="bg-slate-950/50 rounded-2xl border border-white/5 overflow-hidden max-h-[60vh] overflow-y-auto">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                ...
                <tbody className="divide-y divide-white/5">
                  {!report?.soldProductsList || report.soldProductsList.length === 0 ? (
                    <tr><td colSpan="4" className="p-8 text-center text-gray-500">Bu davrda mahsulot sotilmagan.</td></tr>
                  ) : (
                    report.soldProductsList.map((p) => (
                      <tr key={p.id} className="hover:bg-white/[0.02] transition">
                        ...
                        <td className="p-4 text-right text-white font-bold">{formatCurrency(p.totalSalesValue)}</td>
                      </tr>
                    ))
                  )}
                </tbody>
